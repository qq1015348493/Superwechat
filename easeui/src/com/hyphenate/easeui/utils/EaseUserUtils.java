...
public class EaseUserUtils {
    ...
    public static void setAppUserAvatar(Context context, String username, ImageView imageView){
        ...
        if(user != null && user.getAvatar() != null){
            try {
                ...
                //use default avatar
                Glide.with(context).load(user.getAvatar()).diskCacheStrategy(DiskCacheStrategy.ALL).placeholder(R.drawable.default_nor_avatar).into(imageView);
            }
        }else{
            Glide.with(context).load(R.drawable.ease_default_avatar).into(imageView);
        }
    ...
    public static void setCurentAppUserAvatar(Activity activity, ImageView imageView) {
        String username = EMClient.getInstance().getCurrentUser();
    ...
    public static void setAppUserNameWithInfo(String mUserName, TextView textView) {
