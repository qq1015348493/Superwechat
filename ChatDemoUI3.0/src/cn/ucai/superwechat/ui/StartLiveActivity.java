...
public class StartLiveActivity extends LiveBaseActivity
    ...
    @BindView(R.id.start_live_image)
    EaseImageView startLiveImage;
    ...
    protected void onActivityCreate(@Nullable Bundle savedInstanceState) {
        ...
        EaseUserUtils.setAppUserAvatar(this,anchorId,startLiveImage);
        initEnv();
    }
...
//        coverImage.setImageResource(liveRoom.getCover());
    ...
    void onChatImageClick() {
        ConversationListFragment fragment = LiveConversationListFragment.newInstance(null, false);
